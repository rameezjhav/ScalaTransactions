...
object CodingAssignmentConstants {
  ...
  val testDataExtended: List[Transaction] = testData:::List(
    Transaction(transactionId = "t016", accountId = "a002", transactionDay = 4, category = "AA", transactionAmount = 4.0),
    Transaction(transactionId = "t017", accountId = "a001", transactionDay = 4, category = "CC", transactionAmount = 2.0),
    Transaction(transactionId = "t018", accountId = "a002", transactionDay = 4, category = "FF", transactionAmount = 6.0),
    Transaction(transactionId = "t019", accountId = "a001", transactionDay = 4, category = "AA", transactionAmount = 11.0),
    ...
    Transaction(transactionId = "t022", accountId = "a002", transactionDay = 5, category = "AA", transactionAmount = 2.0),
    Transaction(transactionId = "t023", accountId = "a001", transactionDay = 5, category = "CC", transactionAmount = 8.0),
    Transaction(transactionId = "t024", accountId = "a002", transactionDay = 5, category = "FF", transactionAmount = 8.0),
    Transaction(transactionId = "t025", accountId = "a001", transactionDay = 5, category = "AA", transactionAmount = 12.0),
    Transaction(transactionId = "t026", accountId = "a002", transactionDay = 6, category = "CC", transactionAmount = 4.0),
    Transaction(transactionId = "t027", accountId = "a001", transactionDay = 6, category = "FF", transactionAmount = 4.0),
    Transaction(transactionId = "t028", accountId = "a002", transactionDay = 6, category = "AA", transactionAmount = 2.0),
    Transaction(transactionId = "t029", accountId = "a001", transactionDay = 6, category = "CC", transactionAmount = 4.0),
    Transaction(transactionId = "t030", accountId = "a002", transactionDay = 6, category = "FF", transactionAmount = 6.0),
    Transaction(transactionId = "t031", accountId = "a001", transactionDay = 7, category = "AA", transactionAmount = 18.0),
    Transaction(transactionId = "t032", accountId = "a002", transactionDay = 7, category = "CC", transactionAmount = 14.0),
    ...
    Transaction(transactionId = "t035", accountId = "a001", transactionDay = 7, category = "CC", transactionAmount = 12.0)
  )
